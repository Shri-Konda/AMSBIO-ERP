...
class StockPicking(models.Model):
    ...
    def _prepare_edi_delivery_values(self):
        ...
        delivery_values = [
            ...
            self.partner_id.fisher_street or "",
            self.partner_id.fisher_street2 or "",
            self.partner_id.fisher_city or "",
            self.partner_id.fisher_state or "",
            self.partner_id.fisher_zip or "",
